...
export default function PaginaSobre() {
  const valores = [
    ...
    },
    {
      ...
      titulo: 'Segurança',
      descricao: 'Garantimos transparência, verificação de usuários e pagamentos seguros em todas as transações.',
    },
    {
      ...
      <div className="conteudo-6xl">
        <div className="text-center mb-16">
          ...
          <p className="text-xl texto max-w-3xl mx-auto">
            Somos uma plataforma inovadora que conecta clientes, donos de máquinas pesadas e operadores,
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-16">
          <Card className="p-8">
            ...
            <p className="texto mb-4">
              ...
              disponíveis, operadores qualificados e preços justos. A contratação geralmente ocorre via indicações,
          ...
          <Card className="p-8">
            ...
            <p className="texto mb-4">
              Um marketplace inteligente que permite encontrar rapidamente máquinas e operadores disponíveis
              próximos à obra, com orçamento automático, pagamento digital e sistema de avaliação para garantir
        ...
        <section className="bg-navy-500 rounded-lg p-12 text-white mb-16">
          <h2 className="titulo text-center mb-8">Diferenciais da Plataforma</h2>
