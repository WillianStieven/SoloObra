      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/busca" className="text-gray-300 nav-link">
                  Buscar Máquinas
                </Link>
              </li>
              <li>
                <Link href="/como-funciona" className="text-gray-300 nav-link">
                  Como Funciona
                </Link>
              </li>
              <li>
                <Link href="/sobre" className="text-gray-300 nav-link">
                  Sobre Nós
                </Link>
              </li>
              <li>
                <Link href="/cadastro" className="text-gray-300 nav-link">
                  Cadastrar
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/termos" className="text-gray-300 nav-link">
                  Termos de Uso
                </Link>
              </li>
              <li>
                <Link href="/privacidade" className="text-gray-300 nav-link">
                  Política de Privacidade
                </Link>
              </li>
              <li>
                <Link href="/ajuda" className="text-gray-300 nav-link">
                  Central de Ajuda
                </Link>
              </li>
            </ul>
